...
<div class="auth-page">
  ...
  <div class="auth-right">
    <div class="auth-box">
      ...
      <div class="auth-tabs">
        <div class="auth-tab active" onclick="window.location='{{ route('login') }}'">Connexion</div>
        <div class="auth-tab" onclick="window.location='{{ route('register') }}'">Inscription</div>
      </div>
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
          ...
          <div class="password-wrap">
            <input id="mot_de_passe" type="password" name="mot_de_passe"
                   class="form-input @error('mot_de_passe') is-invalid @enderror"
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.4rem">
          ...
          <a href="{{ route('password.request') }}" class="forgot-link" style="margin:0">Mot de passe oublié ?</a>
        </div>

        <button type="submit" class="btn-auth">Se connecter</button>

        <div class="or-divider"><span>ou continuer avec</span></div>
        <a href="{{ route('auth.google') }}" class="btn-social" style="display:flex;align-items:center;justify-content:center;gap:.6rem;text-decoration:none">
