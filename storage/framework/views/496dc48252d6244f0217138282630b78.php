<?php $__env->startSection('title', 'Réservation — Choix du créneau'); ?>
  ...
  <div>
    ...
    <div class="emp-select-section">
      ...
      <?php $__currentLoopData = $employes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="emp-select-row" id="emp-<?php echo e($emp->id); ?>" onclick="selectEmp(this,'<?php echo e($emp->id); ?>','<?php echo e($emp->nomComplet()); ?>')">
          <div class="emp-select-av">
            <img src="<?php echo e($emp->photo_url); ?>" alt="<?php echo e($emp->nomComplet()); ?>">
          </div>
          <div>
            <div class="emp-select-name"><?php echo e($emp->nomComplet()); ?></div>
            <div class="emp-select-role"><?php echo e(implode(', ', $emp->specialites ?? [])); ?></div>
          </div>
          <div class="emp-select-check">&#10003;</div>
        </div>
    ...
    <div class="form-card" style="padding:1.6rem;margin-top:1.5rem">
      <div class="wizard-navigation">
        <a href="<?php echo e(route('reservations.step1', $salonModel->slug)); ?>" class="btn-wizard-back">&#8592; Service</a>
...
var creneauxData = <?php echo json_encode($creneaux, 15, 512) ?>;
...
var step3Url    = '<?php echo e(route('reservations.step3', $salonModel->slug)); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\ISGA\Projet tuteure\Projet Gestion Salon (PHP Laravel)\salonify\resources\views/reservations/step2.blade.php ENDPATH**/ ?>