<?php $__env->startSection('title', 'Nos villes'); ?>
<?php $__env->startSection('meta_description', 'Trouvez un salon de beauté près de chez vous — Salonify couvre Rabat, Casablanca, Marrakech et toutes les grandes villes du Maroc.'); ?>
...
<section class="cities-hero">
  <div class="cities-hero-content wrap">
    ...
    <p class="cities-hero-sub"><?php echo e($villes->count()); ?> villes, <?php echo e($totalSalons); ?>+ salons référencés sur toute l'étendue du royaume.</p>
    ...
    <?php if(auth()->guard()->check()): ?>
      <?php if($villeUtilisateur): ?>
        <div style="margin-top:1rem;padding:.6rem 1.2rem;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.25);border-radius:2px;display:inline-block;font-size:.82rem;color:#fff">
          ...
          <a href="<?php echo e(route('salons.index', $villeUtilisateur->nom_ville)); ?>"
             style="color:#C5A96D;font-weight:700;text-decoration:none">
            <?php echo e($villeUtilisateur->nom_ville); ?> &#8594;
          </a>
          <?php if(Auth::user()->quartier): ?>
            <span style="color:rgba(255,255,255,.65)"> · <?php echo e(Auth::user()->quartier); ?></span>
          <?php endif; ?>
        </div>
      <?php endif; ?>
    <?php endif; ?>
    ...
    <div class="cities-stats">
      <div>
        <div class="city-stat-val"><?php echo e($villes->count()); ?></div>
        <div class="city-stat-lbl">Villes couvertes</div>
      </div>
      <div>
        <div class="city-stat-val"><?php echo e($totalSalons); ?>+</div>
...
<section class="cities-section" id="villesList">
  ...
  <?php $villesPrincipales = $villes->take(2); $autresVilles = $villes->skip(2); ?>

  <div class="cities-grid" style="margin-bottom:3rem">
    <?php $__currentLoopData = $villesPrincipales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ville): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route('salons.index', $ville->nom_ville)); ?>" class="city-card large">
        <img class="city-card-img"
             src="https://images.unsplash.com/photo-<?php echo e($loop->first ? '1555448248-2571daf6344b' : '1558618666-fcd25c85cd64'); ?>?w=600&h=320&fit=crop&q=80"
             alt="<?php echo e($ville->nom_ville); ?>">
        <div class="city-card-overlay">
          <div class="city-card-name"><?php echo e($ville->nom_ville); ?></div>
          <div class="city-card-count"><?php echo e($ville->salons_valides_count); ?> salon<?php echo e($ville->salons_valides_count > 1 ? 's' : ''); ?> disponibles</div>
        </div>
        <?php if($loop->first): ?>
  ...
  <div class="cities-section-header">
    ...
    <span class="cities-section-sub" id="villesCount"><?php echo e($villes->count()); ?> villes</span>
  </div>
  ...
  <div class="cities-grid" id="villesGrid">
    ...
    <?php $__currentLoopData = $villes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ville): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route('salons.index', $ville->nom_ville)); ?>"
         class="city-card ville-item"
         data-nom="<?php echo e(strtolower($ville->nom_ville)); ?>">
        <img class="city-card-img"
             src="https://images.unsplash.com/photo-<?php echo e($photos[$loop->index % count($photos)]); ?>?w=400&h=220&fit=crop&q=80"
             alt="<?php echo e($ville->nom_ville); ?>">
        <div class="city-card-overlay">
          <div class="city-card-name"><?php echo e($ville->nom_ville); ?></div>
          <div class="city-card-count"><?php echo e($ville->salons_valides_count); ?> salon<?php echo e($ville->salons_valides_count > 1 ? 's' : ''); ?></div>
        </div>
        <div class="city-card-arrow">&#8594;</div>
      </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\ISGA\Projet tuteure\Projet Gestion Salon (PHP Laravel)\salonify\resources\views/public/villes.blade.php ENDPATH**/ ?>